...
const THEMES: {
...
}[] = [
  {
    id: 'dark',
    label: 'Sombre',
    description: 'Interface sombre, moins fatigante pour les yeux',
    preview: (
      <div className="w-full h-16 rounded-md overflow-hidden flex flex-col gap-1 p-2" style={{ background: '#0f1117' }}>
        <div className="h-2 w-12 rounded" style={{ background: '#1a1d2e' }} />
        <div className="flex gap-1 flex-1">
          <div className="w-6 rounded" style={{ background: '#13161e' }} />
          <div className="flex-1 rounded" style={{ background: '#1a1d2e' }} />
        </div>
      </div>
    ),
  },
  {
    id: 'pilot',
    label: 'Pilot+',
    description: 'Thème signature, bleu profond',
    preview: (
      <div className="w-full h-16 rounded-md overflow-hidden flex flex-col gap-1 p-2" style={{ background: '#060c1a' }}>
        <div className="h-2 w-12 rounded" style={{ background: '#0e1e3a' }} />
        <div className="flex gap-1 flex-1">
          <div className="w-6 rounded" style={{ background: '#091428' }} />
          <div className="flex-1 rounded" style={{ background: '#0e1e3a' }} />
        </div>
        <div className="h-1 w-8 rounded" style={{ background: 'rgba(59,130,246,0.5)' }} />
      </div>
    ),
  },
  {
    ...
    preview: (
      <div className="w-full h-16 rounded-md overflow-hidden flex flex-col gap-1 p-2 border border-black/5" style={{ background: '#f0f4f8' }}>
        <div className="h-2 w-12 rounded" style={{ background: '#e4eaf3' }} />
        <div className="flex gap-1 flex-1">
          <div className="w-6 rounded" style={{ background: '#e4eaf3' }} />
          <div className="flex-1 rounded" style={{ background: '#ffffff' }} />
        </div>
      </div>
    ),
  },
            ...
            {THEMES.map((t) => {
              ...
              return (
                ...
                >
                  {/* Active checkmark */}
                  {active && (
                    <span className="absolute top-2.5 right-2.5 w-4.5 h-4.5 bg-blue-600 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-white/40 mt-0.5 leading-snug">{t.description}</p>
                  </div>
                </button>
              )
            })}
